...
<header class="churniq-header">
    ...
    <div style="display:flex;gap:.6rem;align-items:center;flex-wrap:wrap;">
        ...
        <span class="badge" style="border-color:rgba(0,230,118,.3);color:var(--green);">ACC 81%</span>
        <span class="badge" style="border-color:rgba(255,170,0,.3);color:var(--warn);"></span>
    </div>
</header>
""", unsafe_allow_html=True)
...
with col2:
    ...
    if analyze:
        ...
        <div class="placeholder-state">
            ...
            <p style="font-size: 0.6rem;">19 features • XGBoost ensemble • 81% accuracy</p>
        </div>
        """, unsafe_allow_html=True)
